...
<head>
    <meta charset="UTF-8">
    <title>Trang Sách Lãng Mạn</title>
    ...
    <div class="row">
        <div class="container d-flex" style="background: #f6ba9c;">
            <div class="col-2 nav-categories" style=" margin-left: -12px;">
                ...
                <a href="langman.php" id="langman" style="background-color: rgb(246, 225, 225);">📖 Lãng Mạn</a>
            ...
            <div class="col-md-9" style="margin-left: 100px;">
                <div id="bannerCarousel" class="carousel slide mb-5" data-bs-ride="carousel" data-bs-interval="3000">
                    <div class="carousel-inner">
                        ...
                        <img src="images/THISFATALKISS.jpg" class="d-block w-100" alt="Banner 1">
                        </div>
                        <div class="carousel-item">
                        <img src="images/CORRIDOR.jpg" class="d-block w-100" alt="Banner 2">
                        </div>
                        <div class="carousel-item">
                        <img src="images/TITHE.jpg" class="d-block w-100" alt="Banner 3">
                        </div>
                    </div>
      ...
      <div class="text-center mb-3">
        <h5 class="fw-bold">LÃNG MẠN</h5>
      </div>

      <div class="row text-center mb-5">
        <div class="col-md-3 mb-4">
          <div class="product-card d-flex flex-column justify-content-between">
            <img src="images/THISFATALKISS.jpg" class="img-fluid mb-2 product-img">
            <p class="fw-bold text-danger">150,000đ</p>
            <p class="product-title">THIS FATAL KISS</p>
            <p class="product-author">Alicia Jasinska</p>
            <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#THISFATALKISS">MUA NGAY</button>
        ...
        <div class="col-md-3 mb-4">
          <div class="product-card d-flex flex-column justify-content-between">
            <img src="images/TITHE.jpg" class="img-fluid mb-2 product-img">
            <p class="fw-bold text-danger">150,000đ</p>
            <p class="product-title">TITHE</p>
            <p class="product-author">Holly Black</p>
            <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#TITHE">MUA NGAY</button>
          </div>
        </div>
      
        <div class="col-md-3 mb-4">
          <div class="product-card d-flex flex-column justify-content-between">
            <img src="images/NEVERLETMEGO.jpg" class="img-fluid mb-2 product-img">
            <p class="fw-bold text-danger">150,000đ</p>
            <p class="product-title">NEVER LET ME GO</p>
            <p class="product-author">Kazuo Ishiguro</p>
            <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#NEVERLETMEGO">MUA NGAY</button>
          </div>
        </div>
      </div>
...
<!-- THIS FATAL KISS -->
<div class="modal fade" id="THISFATALKISS" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header" style="background: #66CCCC;">
          <h5 class="modal-title" id="productModalLabel">THIS FATAL KISS</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Đóng"></button>
        </div>
        <div class="modal-body d-flex" style="background: #f6ba9c;">
          <img src="images/THISFATALKISS.jpg" alt="Bìa sách" class="img-fluid me-4" style="max-width: 250px;">
          <div>
            <p><strong>Tác giả:</strong> Alicia Jasinska</p>
        ...
        <div class="modal-footer" style="background: #66CCCC;">
          ...
          <button class="btn btn-danger" onclick="addToCart('THIS FATAL KISS', 150000, 'images/THISFATALKISS.jpg')">
            Thêm vào giỏ hàng
          </button>
...
<!-- TITHE -->
<div class="modal fade" id="TITHE" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header" style="background: #66CCCC;">
          <h5 class="modal-title" id="productModalLabel">TITHE</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Đóng"></button>
        </div>
        <div class="modal-body d-flex" style="background: #f6ba9c;">
          <img src="images/TITHE.jpg" alt="Bìa sách" class="img-fluid me-4" style="max-width: 250px;">
          <div>
            <p><strong>Tác giả:</strong> Holly Black</p>
            <p><strong>Giá:</strong> <span class="text-danger fw-bold">150,000đ</span></p>
            <p><strong>Tình trạng:</strong> Còn hàng</p>
            <p><strong>Miêu tả:</strong> Khắc họa những câu chuyện tình yêu ngọt ngào và sâu lắng giữa các cặp đôi, 
              sách lãng mạn đưa người đọc trải qua cung bậc cảm xúc của yêu thương, nhớ nhung và gắn kết.</p>            
        ...
        <div class="modal-footer" style="background: #66CCCC;">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
          <button class="btn btn-danger" onclick="addToCart('TITHE', 150000, 'images/TITHE.jpg')">
            Thêm vào giỏ hàng
          </button>
...
<!-- NEVER LET ME GO -->
<div class="modal fade" id="NEVERLETMEGO" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header" style="background: #66CCCC;">
          <h5 class="modal-title" id="productModalLabel">NEVER LET ME GO</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Đóng"></button>
        </div>
        <div class="modal-body d-flex" style="background: #f6ba9c;">
          <img src="images/NEVERLETMEGO.jpg" alt="Bìa sách" class="img-fluid me-4" style="max-width: 250px;">
          <div>
            <p><strong>Tác giả:</strong> Kazuo Ishiguro</p>
            <p><strong>Giá:</strong> <span class="text-danger fw-bold">150,000đ</span></p>
            <p><strong>Tình trạng:</strong> Còn hàng</p>
            <p><strong>Miêu tả:</strong> Khắc họa những câu chuyện tình yêu ngọt ngào và sâu lắng giữa các cặp đôi, 
              sách lãng mạn đưa người đọc trải qua cung bậc cảm xúc của yêu thương, nhớ nhung và gắn kết.</p>            
        ...
        <div class="modal-footer" style="background: #66CCCC;">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
          <button class="btn btn-danger" onclick="addToCart('NEVER LET ME GO', 150000, 'images/NEVERLETMEGO.jpg')">
            Thêm vào giỏ hàng
          </button>
