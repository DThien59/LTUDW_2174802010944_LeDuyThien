...
<head>
    <meta charset="UTF-8">
    <title>Trang Sách Cổ Tích</title>
    ...
    <div class="row">
        <div class="container d-flex" style="background: #f6ba9c;">
            <div class="col-2 nav-categories" style=" margin-left: -12px;">
                ...
                <a href="cotich.php" id="cotich" style="background-color: rgb(246, 225, 225);">📖 Cổ Tích</a>
            ...
            <div class="col-md-9" style="margin-left: 100px;">
                <div id="bannerCarousel" class="carousel slide mb-5" data-bs-ride="carousel" data-bs-interval="3000">
                    <div class="carousel-inner">
                        ...
                        <img src="images/INTOTHEWOODS.jpg" class="d-block w-100" alt="Banner 1">
                        </div>
                        <div class="carousel-item">
                        <img src="images/WITCH.jpg" class="d-block w-100" alt="Banner 2">
                        </div>
                        <div class="carousel-item">
                        <img src="images/THREESHADOWS.jpg" class="d-block w-100" alt="Banner 3">
                        </div>
                    </div>
      ...
      <div class="text-center mb-3">
        <h5 class="fw-bold">CỔ TÍCH</h5>
      </div>

      <div class="row text-center mb-5">
        <div class="col-md-3 mb-4">
          <div class="product-card d-flex flex-column justify-content-between">
            <img src="images/INTOTHEWOODS.jpg" class="img-fluid mb-2 product-img">
            <p class="fw-bold text-danger">150,000đ</p>
            <p class="product-title">INTO THE WOODS</p>
            <p class="product-author">Lynchburg College</p>
            <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#INTOTHEWOODS">MUA NGAY</button>
        ...
        <div class="col-md-3 mb-4">
          <div class="product-card d-flex flex-column justify-content-between">
            <img src="images/THREESHADOWS.jpg" class="img-fluid mb-2 product-img">
            <p class="fw-bold text-danger">150,000đ</p>
            <p class="product-title">THREE SHADOWS</p>
            <p class="product-author">Cyril Pedrosa</p>
            <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#THREESHADOWS">MUA NGAY</button>
          </div>
        </div>
      
        <div class="col-md-3 mb-4">
          <div class="product-card d-flex flex-column justify-content-between">
            <img src="images/WATCHHOLLOW.jpg" class="img-fluid mb-2 product-img">
            <p class="fw-bold text-danger">150,000đ</p>
            <p class="product-title">WATCH HOLLOW</p>
            <p class="product-author">Gregory Funaro</p>
            <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#WATCHHOLLOW">MUA NGAY</button>
          </div>
        </div>
      </div>
...
<!-- INTO THE WOODS -->
<div class="modal fade" id="INTOTHEWOODS" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header" style="background: #66CCCC;">
          <h5 class="modal-title" id="productModalLabel">INTO THE WOODS</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Đóng"></button>
        </div>
        <div class="modal-body d-flex" style="background: #f6ba9c;">
          <img src="images/INTOTHEWOODS.jpg" alt="Bìa sách" class="img-fluid me-4" style="max-width: 250px;">
          <div>
            <p><strong>Tác giả:</strong> Lynchburg College</p>
        ...
        <div class="modal-footer" style="background: #66CCCC;">
          ...
          <button class="btn btn-danger" onclick="addToCart('INTO THE WOODS', 150000, 'images/INTOTHEWOODS.jpg')">
            Thêm vào giỏ hàng
          </button>
...
<!-- THREE SHADOWS -->
<div class="modal fade" id="THREESHADOWS" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header" style="background: #66CCCC;">
          <h5 class="modal-title" id="productModalLabel">THREE SHADOWS</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Đóng"></button>
        </div>
        <div class="modal-body d-flex" style="background: #f6ba9c;">
          <img src="images/THREESHADOWS.jpg" alt="Bìa sách" class="img-fluid me-4" style="max-width: 250px;">
          <div>
            <p><strong>Tác giả:</strong> Cyril Pedrosa</p>
            <p><strong>Giá:</strong> <span class="text-danger fw-bold">150,000đ</span></p>
            <p><strong>Tình trạng:</strong> Còn hàng</p>
            <p><strong>Miêu tả:</strong> Mang màu sắc huyền ảo và đầy phép màu, truyện cổ tích đưa người đọc vào thế giới 
              diệu kỳ với bài học nhân văn sâu sắc và những cái kết đầy hy vọng.</p>            
        ...
        <div class="modal-footer" style="background: #66CCCC;">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
          <button class="btn btn-danger" onclick="addToCart('THREE SHADOWS', 150000, 'images/THREESHADOWS.jpg')">
            Thêm vào giỏ hàng
          </button>
...
<!-- WATCH HOLLOW -->
<div class="modal fade" id="WATCHHOLLOW" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header" style="background: #66CCCC;">
          <h5 class="modal-title" id="productModalLabel">WATCH HOLLOW</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Đóng"></button>
        </div>
        <div class="modal-body d-flex" style="background: #f6ba9c;">
          <img src="images/WATCHHOLLOW.jpg" alt="Bìa sách" class="img-fluid me-4" style="max-width: 250px;">
          <div>
            <p><strong>Tác giả:</strong> Gregory Funaro</p>
            <p><strong>Giá:</strong> <span class="text-danger fw-bold">150,000đ</span></p>
            <p><strong>Tình trạng:</strong> Còn hàng</p>
            <p><strong>Miêu tả:</strong> Mang màu sắc huyền ảo và đầy phép màu, truyện cổ tích đưa người đọc vào thế giới 
              diệu kỳ với bài học nhân văn sâu sắc và những cái kết đầy hy vọng.</p>            
        ...
        <div class="modal-footer" style="background: #66CCCC;">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
          <button class="btn btn-danger" onclick="addToCart('WATCH HOLLOW', 150000, 'images/WATCHHOLLOW.jpg')">
            Thêm vào giỏ hàng
          </button>
